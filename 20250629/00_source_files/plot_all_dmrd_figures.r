...
)
{
    ...
    ggsave( 
        file.path( redu.figure.dir, 
            sprintf( "%s_all_events_cluster.jpg", redu.figure.plot ) ), 
        redu.plot, 
    ...
    ggsave( 
        file.path( redu.figure.dir, 
            sprintf( "%s_all_events_condition.jpg", redu.figure.plot ) ), 
        redu.plot, 
        width = the.dmrd.figure.width, height = the.dmrd.figure.height 
    )
    ...
    for ( fch in 1:length(fcs.channel.label) )
    {
        ...
        ggsave( 
            file.path( redu.figure.dir, 
                sprintf( "%s_all_events_%s.jpg", redu.figure.plot, 
    ...
    ggsave( 
        file.path( redu.figure.dir, 
            sprintf( "%s_all_conditions_cluster.jpg", redu.figure.plot ) ), 
        redu.plot, 
    ...
    for ( fch in 1:length(fcs.channel.label) )
    {
        ...
        ggsave( 
            file.path( redu.figure.dir, 
                sprintf( "%s_all_conditions_%s.jpg", redu.figure.plot, 
                         fcs.channel.label[ fch ] ) ), 
            redu.plot, 
            width = the.dmrd.figure.width.multi, 
            height = the.dmrd.figure.height.multi 
    ...
    for ( cond in fcs.condition )
    {
        ...
        ggsave( 
            file.path( redu.figure.dir, 
                sprintf( "%s_%s_cluster.jpg", redu.figure.plot, 
    ...
    for ( cond in fcs.condition )
    {
        ...
        ggsave( 
            file.path( redu.figure.dir, 
                sprintf( "%s_%s_sample.jpg", redu.figure.plot, 
                    fcs.condition.label[ cond ] ) ), 
            redu.plot, 
            width = the.dmrd.figure.width, height = the.dmrd.figure.height 
        )
